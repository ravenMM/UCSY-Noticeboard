...
public class StatusRecyclerAdapter extends FirebaseRecyclerAdapter<NoticeboardModel, StatusRecyclerAdapter.StatusViewHolder> {

    private Context mContext;
    private DatabaseReference mLinkRefernece;

    public StatusRecyclerAdapter(Context context, Query ref) {
